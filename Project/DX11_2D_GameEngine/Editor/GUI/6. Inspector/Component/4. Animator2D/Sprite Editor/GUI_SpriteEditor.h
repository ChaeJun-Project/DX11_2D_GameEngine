...
private:
	...
	const bool CheckMousePositionInRect
	(
		const ImVec2& mouse_position,
		const Vector2& rect_left_top,
		const Vector2& rect_right_bottom
	);
...
private:
	...
	Vector2 atlas_texture_size = Vector2::Zero;
	...
	ImVec2 start_point_in_canvas = ImVec2(0.0f, 0.0f);
	ImVec2 end_point_in_canvas = ImVec2(0.0f, 0.0f);
	Vector2 draw_left_top = Vector2(0.0f, 0.0f);
	Vector2 draw_right_bottom = Vector2(0.0f, 0.0f);
