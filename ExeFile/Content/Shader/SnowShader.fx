...
[maxvertexcount(6)]
//Geometry Shader
void GS(point VS_OUT gs_input[1], inout TriangleStream<VertexColorTextureLightOutputType> gs_output_stream)
{
    ...
    //출력시킬 4개의 정점
    VertexColorTextureLightOutputType gs_output[4];
    ...
    gs_output[0].world_position = particle_world_position;
    ...
    gs_output[1].world_position = particle_world_position;
    ...
    gs_output[2].world_position = particle_world_position;
    ...
    gs_output[3].world_position = particle_world_position;
